            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li
                            class="dropdown {{ Request::is('kuisioner') || Request::is('kuisioner-skor') || Request::is('kuisioner-kurasi') ? 'active' : '' }}">
                            <a href="#" class="nav-link has-dropdown"><i
                                    class="fas fa-fire"></i><span>Settings</span></a>
                            <ul class="dropdown-menu">
                                <li class="{{ Request::is('kuisioner') ? 'active' : '' }}"><a class="nav-link"
                                        href="/kuisioner">Kuisioner</a></li>
                                <li class="{{ Request::is('kuisioner-skor') ? 'active' : '' }}"><a class="nav-link"
                                        href="/kuisioner-skor">Kuisioner Skor</a></li>
                                <li class="{{ Request::is('kuisioner-kurasi') ? 'active' : '' }}"><a class="nav-link"
                                        href="/kuisioner-kurasi">Kuisioner Kurasi</a>
                                </li>
                            </ul>
                        </li>
                        <li
                            class="dropdown {{ Request::is('umkm-registered') || Request::is('umkm-qualified') || Request::is('umkm-unqualified') || Request::is('umkm-verified') ? 'active' : '' }}">
                            <a href="#" class="nav-link has-dropdown"><i
                                    class="fas fa-fire"></i><span>UMKM</span></a>
                            <ul class="dropdown-menu">
                                <li class="{{ Request::is('umkm-registered') ? 'active' : '' }}"><a class="nav-link"
                                        href="/umkm-registered">UMKM Registered</a></li>
                                ...
                                <li class="{{ Request::is('umkm-verified') ? 'active' : '' }}"><a class="nav-link"
                                        href="/umkm-verified">UMKM Verified</a></li>
                            </ul>
                        </li>
                        <li
                            class="dropdown {{ Request::is('umkm-qualified') || Request::is('umkm-assesment') ? 'active' : '' }}">
