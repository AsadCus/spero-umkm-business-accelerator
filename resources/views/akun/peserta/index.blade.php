    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1 style="width:85%">Management UMKM</h1>
                {{-- <a class="btn btn-success" href="/user/umkm/create">
            ...
            <div class="section-body">
                <div class="card">
                    <div class="card-body">
                        <strong class="text-dark">List UMKM</strong>
                        <hr />
                        <div class="row">
                            <div class="col-12">
        ...
        $(document).ready(function() {
            var table = $('#datatable').DataTable({
                ...
                columns: [{
                    ...
                    //         var deleteUrl = '/user/umkm/delete/' + data.id;
                    //         var editUrl = '/user/umkm/edit/' + data.id;
