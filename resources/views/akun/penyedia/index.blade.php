    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1 style="width:85%">Management Penyedia</h1>
                {{-- <a class="btn btn-success" href="/user/penyedia/create">
            ...
            <div class="section-body">
                <div class="card">
                    <div class="card-body">
                        <strong class="text-dark">List Penyedia</strong>
                        <hr />
                        <div class="row">
                            <div class="col-12">
        ...
        $(document).ready(function() {
            var table = $('#datatable').DataTable({
                ...
                columns: [{
                    ...
                    //         var deleteUrl = '/user/penyedia/delete/' + data.id;
                    //         var editUrl = '/user/penyedia/edit/' + data.id;
