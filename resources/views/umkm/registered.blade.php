    ...
    <div class="card-body">
        <div class="table-responsive">
            ...
            <div id="table_wrapper" class="dataTables_wrapper no-footer">
              ...
              <thead>
                <tr role="row"><th class="text-center sorting_asc" scope="col" tabindex="0" aria-controls="table" rowspan="1" colspan="1" aria-sort="ascending" aria-label="#: activate to sort column descending" style="width: 19.8906px;">#</th><th class="text-center sorting" scope="col" tabindex="0" aria-controls="table" rowspan="1" colspan="1" aria-label="Nama Bisnis: activate to sort column ascending" style="width: 232.328px;">Nama Bisnis</th><th class="text-center sorting" scope="col" tabindex="0" aria-controls="table" rowspan="1" colspan="1" aria-label="Nama: activate to sort column ascending" style="width: 216px;">Nama</th><th class="text-center sorting" scope="col" tabindex="0" aria-controls="table" rowspan="1" colspan="1" aria-label="Submit?: activate to sort column ascending" style="width: 72.7812px;">Submit?</th><th class="text-center sorting" scope="col" tabindex="0" aria-controls="table" rowspan="1" colspan="1" aria-label="Use?: activate to sort column ascending" style="width: 72.6875px;">Use?</th><th class="text-center sorting" scope="col" tabindex="0" aria-controls="table" rowspan="1" colspan="1" aria-label="Level: activate to sort column ascending" style="width: 58.3125px;">Skor</th><th class="text-center sorting" scope="col" tabindex="0" aria-controls="table" rowspan="1" colspan="1" aria-label="Aksi: activate to sort column ascending" style="width: 65px;">Aksi</th></tr>
              </thead>
              <tbody>
                    ...
                    <td><span class="badge badge-success badge-sm"><i class="fa fa-check"></i></span></td>
                    ...
                    <td><span class="badge badge-warning badge-sm"><i class="fa fa-times"></i></span></td>
                    <td><span class="badge badge-dark"><i class="fa fa-desktop"></i> App</span></td>
                    ...
                    <td>Toko Sinar Matahari Raya</td>
                    <td>Anjas Anjas</td>
