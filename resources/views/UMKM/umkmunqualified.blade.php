...
@section('title', 'UMKM UnQualified')
        ...
        <div class="table-responsive">
            ...
            <div id="table_wrapper" class="dataTables_wrapper no-footer">
              ...
              <tbody>
                    ...
                    <td><a type="button" target="_blank" href="verif-page/3/Tm92aWNl" class="btn btn-sm btn-success"><i class="fa fa-sign-in"></i> Qualified</a> </td>
                  </tr></tbody>
